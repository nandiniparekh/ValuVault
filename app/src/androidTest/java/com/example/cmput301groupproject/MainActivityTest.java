...
public class MainActivityTest {
    ...
    public void testEditItem() {
        ...
        // Verify if the edit dialog is displayed with the current item details
        onView(withText("Edit Item")).check(matches(isDisplayed()));
        // Make changes to the item details
        onView(withId(R.id.description_edit_text)).perform(ViewActions.typeText(" - Edited"));
    ...
    public void testDeleteItem() {
        // Assuming dataList is not empty, perform a long click on the first item in the list
        onView(withId(R.id.item_list)).perform(click());
